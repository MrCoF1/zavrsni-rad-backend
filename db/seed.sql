...
FROM (VALUES
    ...
    ('Skullcrushers', 'Upper'), ('Skullcrushers', 'Pull'), ('Skullcrushers', 'Full Body'),
    ('Bulgarian Squat', 'Lower'), ('Bulgarian Squat', 'Full Body'),
    ('Squat (Barbell)', 'Lower'), ('Squat (Barbell)', 'Full Body'),
    ('Quad Extensions', 'Lower'), ('Quad Extensions', 'Full Body'),
    ('Leg Press', 'Lower'), ('Leg Press', 'Full Body'),
    ('Hack Squat', 'Lower'), ('Hack Squat', 'Full Body'),
    ('Romanian Deadlift', 'Lower'), ('Romanian Deadlift', 'Full Body'),
    ('Hamstring Curls Machine', 'Lower'), ('Hamstring Curls Machine', 'Full Body'),
    ('Calf Raises', 'Lower'), ('Calf Raises', 'Full Body'),
